...
void worldesp::smoke_timer(entity_t* entity)
{
	...
	render::get().text(fonts[ESP], screen_origin.x, screen_origin.y - size.y * 0.5f + 12.0f, Color(191, 191, 191), HFONT_CENTERED_X | HFONT_CENTERED_Y, "");
	render::get().text(fonts[GRENADESINDICATOR], screen_origin.x + 1.0f, screen_origin.y - size.y * 0.5f + 2.0f, Color(200, 200, 200), HFONT_CENTERED_X | HFONT_CENTERED_Y, "k");
	render::get().Draw3DFilledCircle(origin, 140.0f, g_cfg.esp.molotov_timer ? Color(255, 255, 255, (int)(alpha * 24.0f)) : Color(255, 255, 255, (int)(alpha * 24.0f)));
}
